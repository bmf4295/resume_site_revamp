...
const NavBar = () => {
  ...
  return (
    <nav data-testid="navbar" className="fixed top-0 left-0 w-full bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-50">
      ...
      <div 
        ...
        } sm:hidden flex-col space-y-4 py-4 px-2 bg-white dark:bg-gray-900 rounded-b-lg`}
      >
        <a
          href="#home"
          onClick={(e) => handleScroll(e, "home")}
