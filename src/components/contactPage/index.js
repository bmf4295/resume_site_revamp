const Contact = () => {
    const handleEmailClick = () => {
        window.location.href = "mailto:me@bradyfriese.com?subject=Hello Brady&body=I would like to connect with you regarding...";
    };

    return (
        <div className="flex flex-col bg-inherit min-h-screen pt-24 px-6" id="Contact">
